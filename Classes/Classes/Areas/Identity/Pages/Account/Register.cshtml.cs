...
namespace Classes.Areas.Identity.Pages.Account {
   public class RegisterModel : PageModel {
      ...
      /// <summary>
      ///    this attribute is used to send,
      ///    and retrieve, data to/from users interface
      /// </summary>
      [BindProperty]
      ...
      /// <summary>
      /// this 'inner class' defines the attributes that 
      /// we use to 'talk' with the registration interface 
      /// </summary>
      public class InputModel {
         ...
         /// <summary>
         /// data from Professor that user must add
         /// </summary>
